...
<form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
	...
	<div class="input-group">
		<i id="searchtoggle" class="fa fa-2x fa-search" aria-hidden="true"></i><input type="text" class="input-group-field" value="" name="s" id="s" placeholder="<?php esc_attr_e( 'Search', 'foundationpress' ); ?>">
